...
class SchoolDesktopView extends StatefulWidget {
  @override
  _SchoolDesktopViewState createState() => _SchoolDesktopViewState();
}

class _SchoolDesktopViewState extends State<SchoolDesktopView> {
  String linkedinUrl =
        ...
        RaisedButton(
          ...
          child: Padding(
            ...
            child: Text(
              ...
              style:
                  GoogleFonts.poppins(color: Colors.brown[100], fontSize: 18),
            ),
          ),
          color: primaryColor,
          elevation: 8.0,
        ...
        RichText(
          text: TextSpan(children: [
            TextSpan(
              ...
              style: TextStyle(
                  fontWeight: FontWeight.bold, color: Colors.yellow[300]),
            ),
            TextSpan(
                text: "that's all folks.",
                style: GoogleFonts.poppins(color: Colors.brown[100])),
          ]),
        ),
        Row(
